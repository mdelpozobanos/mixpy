...
setup(
    name='mixpy',
    version=find_version('mixpy/__init__.py'),
    description='MixPy contains a mix of useful methods',
    long_description=read('README.rst') + read('HISTORY.rst'),
    author='Marcos DelPozo-Banos',
    author_email='mdelpozobanos@gmail.com',
    url='https://github.com/mdelpozobanos/mixpy',
    packages=[
        'mixpy',
    ],
    package_dir={'mixpy': 'mixpy'},
